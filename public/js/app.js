...
/* harmony import */ var _plugins_veevalidate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./plugins/veevalidate */ "./resources/js/plugins/veevalidate.js");
...
(axios__WEBPACK_IMPORTED_MODULE_0___default().defaults.baseURL) = process.env.VUE_APP_API_URL || "http://localhost:3000";
...
axios__WEBPACK_IMPORTED_MODULE_0___default().interceptors.response.use(function (response) {
  ...
  if (error && error.response.status === 401) {
    _router_index__WEBPACK_IMPORTED_MODULE_1__["default"].push('/login')["catch"](function () {});
...
Plugin.install = function (Vue) {
  Vue.axios = (axios__WEBPACK_IMPORTED_MODULE_0___default());
...
/***/ "./resources/js/plugins/veevalidate.js":
/*!*********************************************!*\
  !*** ./resources/js/plugins/veevalidate.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(0,vee_validate__WEBPACK_IMPORTED_MODULE_1__.extend)('required', Object(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/rules'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
(0,vee_validate__WEBPACK_IMPORTED_MODULE_1__.extend)('confirmed', Object(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/rules'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
(0,vee_validate__WEBPACK_IMPORTED_MODULE_1__.extend)('email', Object(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/rules'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
(0,vee_validate__WEBPACK_IMPORTED_MODULE_1__.extend)('min', Object(function webpackMissingModule() { var e = new Error("Cannot find module 'vee-validate/dist/rules'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
(0,vee_validate__WEBPACK_IMPORTED_MODULE_1__.extend)('password', {
...
vue__WEBPACK_IMPORTED_MODULE_2__["default"].use(vee_validate__WEBPACK_IMPORTED_MODULE_1__, {
  errorBagName: 'vErrors'
});
vue__WEBPACK_IMPORTED_MODULE_2__["default"].component('ValidationProvider', vee_validate__WEBPACK_IMPORTED_MODULE_1__.ValidationProvider);
vue__WEBPACK_IMPORTED_MODULE_2__["default"].component('ValidationObserver', vee_validate__WEBPACK_IMPORTED_MODULE_1__.ValidationObserver);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (vee_validate__WEBPACK_IMPORTED_MODULE_1__);
...
/******/ 			if ({"login":1,"register":1}[chunkId]) return "js/" + chunkId + ".js";
