...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    // Stex dnumes tableit zapros@
    // const {data} = this.$axios.get('/tableData');
    // this.customers = data;
    this.filtered_customers = this.customers;
  },
  methods: {
    searchInTable: function searchInTable(searchText) {
      var customer_list = _toConsumableArray(this.customers);

      if (searchText) {
        var matched = customer_list.filter(function (customer) {
          return customer.company.includes(searchText) || customer.contact.includes(searchText) || customer.country.includes(searchText);
        });
        this.filtered_customers = matched;
      } else {
        this.filtered_customers = this.customers;
      }
    }
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\ninput[type=\"text\"][data-v-63cd6604],\nselect[data-v-63cd6604] {\n  width: 50%;\n  padding: 12px 20px;\n  margin: 8px 0;\n  display: inline-block;\n  border: 1px solid #ccc;\n  border-radius: 4px;\n  box-sizing: border-box;\n}\n#customers[data-v-63cd6604] {\n  font-family: Arial, Helvetica, sans-serif;\n  border-collapse: collapse;\n  width: 50%;\n  margin: auto;\n}\n#customers td[data-v-63cd6604],\n#customers th[data-v-63cd6604] {\n  border: 1px solid #ddd;\n  padding: 8px;\n}\n#customers tr[data-v-63cd6604]:nth-child(even) {\n  background-color: #f2f2f2;\n}\n#customers tr[data-v-63cd6604]:hover {\n  background-color: #ddd;\n}\n#customers tr td[data-v-63cd6604] {\n  text-align: left;\n}\n#customers th[data-v-63cd6604] {\n  padding-top: 12px;\n  padding-bottom: 12px;\n  text-align: left;\n  background-color: #04aa6d;\n  color: white;\n}\n", ""]);
// Exports
...
var render = function () {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("div", [
        _c("h1", [_vm._v("A Fancy Table")]),
        _vm._v(" "),
        _c("div", { staticClass: "search_block" }, [
          _c("input", {
            directives: [
              {
                name: "model",
            ...
            on: {
              input: [
                ...
                function ($event) {
                  return _vm.searchInTable(_vm.search_query)
                },
              ],
            },
          }),
        ...
        _c(
          ...
          [
            _c(
              "tr",
              _vm._l(_vm.table_headers, function (header, index) {
            ...
            _vm._v(" "),
            _vm._l(_vm.filtered_customers, function (customer, index) {
              return _c(
                "tr",
                { key: index },
                _vm._l(_vm.table_headers, function (header, idx) {
                  return _c("td", { key: idx }, [
                    _vm._v(
                      "\n          " +
                        _vm._s(customer[header.key]) +
                        "\n        "
                    ),
                  ])
                }),
